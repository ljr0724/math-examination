...
\begin{enumerate}[start=16] %大题从16开始编号
 ...
 \begin{flushright}
        \begin{tikzpicture}
            ...
            \coordinate (D) at (0.6,-1.8);
            \coordinate (E) at (3.1,0);
            \coordinate (A) at (1.9,1.8);
    ...
    \begin{flushright}
    \tdplotsetmaincoords{77}{200}  % 设置视角
    \begin{tikzpicture}[tdplot_main_coords]
        \coordinate (C) at (0,0,0);
        \coordinate (C_1) at (-1.5,0,2.5);
        \coordinate (B) at (0,3,0);
        \coordinate (B_1) at (-1.5,3,2.5);
        \coordinate (A) at (3,0,0);
        \coordinate (A_1) at (1.5,0,2.5);
        \coordinate (D) at (1.5,0,0);
        
        \draw (A)--(B)--(C);
        \draw (A_1)--(C_1)--(B_1)--(A_1);
